...
public class QueueUtils {
    ...
    public static <T> T elementQueueObject(String queueName) {
        try {
            RBlockingQueue<T> queue = CLIENT.getBlockingQueue(queueName);
            return queue.peek();
        } catch (Exception e) {
    ...
    public static int getQueueObjectSize(String queueName) {
        return CLIENT.getBlockingQueue(queueName).size();
    }
